...
<body>
		...
		<div id="content">
			<div class="col-md-12" style="background-color: #343A46 ">
				<center>
					...
					CLIENTE: <?php echo $datosCliente[0] ?> <br>
					SALDO: <?php echo $datosCliente[1] ?> <br>
					SALDO EN VALES: <?php echo $datosCliente[2] ?> 
					</h1>
				</center>
	   		</div>
			<!-- Col 2 -->
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$('#mainset').load('tabla.admine.estadoCuenta.view.php');
		});
	</script>
